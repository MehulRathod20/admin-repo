                        ...
                        <div class="card" id="card">
                            ...
                            <div class="card-content">
                                <div class="card-body">
                                    ...
                                    $sql = "SELECT * FROM footermenu WHERE id = '{$id}'";
                                    ...
                                    if (mysqli_num_rows($result) > 0) {
                                        ...
                                        while($row = mysqli_fetch_assoc($result)){
                                            ...
                                            ?>
                                            <form action="update-footer-menu.php" method="POST"class="form form-vertical">
                                                <div class="form-body">
                                                    <div class="row">
                                                        <div class="col-12">
                                                            <div class="form-group" hidden>
                                                                <label for="">id</label>
                                                                <input type="text" id="menu"class="form-control mt-2" name="id"placeholder="Enter Menu Name" value="<?php echo $row['id'];?>">
                                                            </div>
                                                        </div>
                                                        <div class="col-12">
                                                            <div class="form-group">
                                                                <label for="">Main Menu</label>
                                                                <input type="text" id="menu"class="form-control mt-2" name="menu"placeholder="Enter Menu Name" value="<?php echo $row['menu'];?>">
                                                            </div>
                                                        </div>
                                                        <div class="col-12">
                                                            <div class="form-group">
                                                                <label for="">Sub Menu</label>
                                                                <input type="text" id="submenu" class="form-control mt-2" name="submenu" placeholder="Enter Sub-Menu Name" value="<?php echo $row['submenu'];?>">
                                                            </div>
                                                        </div>
                                                          <div class="col-12">
                                                            <div class="form-group">
                                                                <label for="">copyright</label>
                                                                <input type="text" id="submenu" class="form-control mt-2" name="copyright" placeholder="Enter copyright" value="<?php echo $row['copyright'];?>">
                                                            </div>
                                                        </div>
